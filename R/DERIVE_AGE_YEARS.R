...
#'
#' @description Convert the AGE of all subjects to years and change the AGEU to "YEARS".
#'
#' @param DATA Data frame containing the AGE and AGEU variables; typically the Demographics (DM) domain.
#'
#' @return Data frame with AGE and AGEU in years as opposed to the original values.
#'
#' @author Rhys Peploe
#'
#' @example
