...
Alternatively, we have created a bank of alternative spellings of countries, `country_name_lookup.xlsx` (see [inst/extdata in GitHub](https://github.com/Infectious-Diseases-Data-Observatory/worlddatr/tree/main/inst/extdata)), designed to cover a wide range of naming structures. Users can left join your data with that bank of spellings, so your data is matched and appended with the ISO codes if there is a match. 
