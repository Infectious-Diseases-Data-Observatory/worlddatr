...
derive_df_raw <- data.frame(
  ...
  RFSTDTC = c(as.Date("2023/01/01"), as.Date("2023/04/01"), 
...
```{r}
lb_df <- data.frame(
  STUDYID = c("RPTESTB", "RPTESTB", "RPTESTB", "RPTESTB", "RPTESTB", "RPTESTB", 
              "RPTESTB", "RPTESTB", "RPTESTB", "RPTESTB"),
  DOMAIN = "LB",
  USUBJID = c("RPTESTB_001", "RPTESTB_001", "RPTESTB_001", "RPTESTB_002", "RPTESTB_002", 
              "RPTESTB_002", "RPTESTB_002", "RPTESTB_003", "RPTESTB_003", "RPTESTB_003"),
  LBTESTCD = c("HGB", "PLAT", "HGB", "HGB", "PLAT", "HGB", "HCG", "HGB", "PLAT", "HGB"),
  LBTEST = c("Hemoglobin", "Platelets", "Hemoglobin", "Hemoglobin", "Platelets", 
  ...
  EPOCH = c("BASELINE", "TREATMENT", "FOLLOW UP", "BASELINE", "TREATMENT", "FOLLOW UP", 
